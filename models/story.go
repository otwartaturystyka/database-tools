...
func (s *Story) makeMarkdownPath() error {
	wd, err := os.Getwd()
	if err != nil {
		return fmt.Errorf("get working dir: %w", err)
	}

	// FIXME: use markdown path for the correct language
	s.markdownPath = filepath.Join(wd, "content", "pl", s.MarkdownFile+".md")
	return nil
}
